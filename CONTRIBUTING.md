...
You should fork the Vunnel repo using the "Fork" button at the top right of the Vunnel GitHub [site](https://github.com/nextlinux/vunnel/). You will be doing your development in your fork, then submit a pull request to Vunnel. There are many resources how to use GitHub effectively, we will not cover those here.
