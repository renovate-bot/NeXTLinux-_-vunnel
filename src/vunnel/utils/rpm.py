...
def split_rpm_filename(
        rpm_filename: str) -> tuple[str | None, str, str, str | None, str]:
    """
...
def split_fullversion(
        version: str) -> tuple[str | None, str | None, str | None]:
    """
    ...
    Use this function for splitting versions already processed by nextlinux engine.
...
def compare_versions(ver_a: str, ver_b: str) -> int:
    """
    Compare pkg and versions using nextlinux engine rules.
...
def compare_labels(evr_1: tuple[str | None, str | None, str | None],
                   evr_2: tuple[str | None, str | None, str | None]) -> int:
    """
...
def rpm_ver_cmp(a: str | None,
                b: str | None) -> int:  # noqa: C901,PLR0912,PLR0911
    """
...
def greedy_find_block(
        list_str: list[str],
        expected_digit: bool | None = None) -> tuple[bool, list[str]]:
    """
